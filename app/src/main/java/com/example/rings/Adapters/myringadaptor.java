...
public class myringadaptor extends RecyclerView.Adapter<myringadaptor.MyViewHolder> {
    ...
    public myringadaptor(Context cxt,OnShareClickedListener ct, List<myringmodel> myDataset) {
        contxt = cxt;
        mCallback = ct;
        mDataset = myDataset;
    }
    ...
    @Override
    public myringadaptor.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
        // create a new view
